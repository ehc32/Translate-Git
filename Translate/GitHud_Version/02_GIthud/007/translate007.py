...
# -----------------------------------------------------------------------
# Parser MT210 (bloque 4)
# -----------------------------------------------------------------------
MT_FIELD_RE = re.compile(r":([0-9A-Z]{2,3}[A-Z]?):")


def parse_MT210(text: str) -> Dict[str, Any]:
    """Extrae campos del MT210. Devuelve {"blocks":{...}, "fields":{tag:value}}"""
...
NS = {
    ...
    "camt": "urn:iso:std:iso:20022:tech:xsd:camt.057.001.06",
...
# -----------------------------------------------------------------------
# Orden jerárquico para camt.057
# -----------------------------------------------------------------------
def _gen_paths(base, paths):
    return [f"{base}.{p}" for p in paths]


UNIVERSAL_CAMT057_ORDER = [
    # Header.Message
    *_gen_paths(
        ".Header.Message",
    ...
    *_gen_paths(
        ".Body.Document.NtfctnToRcv.GrpHdr",
        [
            "MsgId",
            "CreDtTm",
        ],
    ...
    *_gen_paths(
        ...
        [
            ...
            "DbtrAgt.FinInstnId.PstlAdr.StrtNm",
            "DbtrAgt.FinInstnId.PstlAdr.TwnNm",
            "DbtrAgt.FinInstnId.PstlAdr.Crty",
            "DbtrAgt.FinInstnId.PstlAdr.AdrLine",
            "IntrmyAgt.FinInstnId.BICFI",
            "IntrmyAgt.FinInstnId.ClrSysMmbId.MmbId",
            "IntrmyAgt.FinInstnId.Nm",
            "IntrmyAgt.FinInstnId.PstlAdr.AdrLine[0]",
            "IntrmyAgt.FinInstnId.PstlAdr.AdrLine[1]",
            "IntrmyAgt.FinInstnId.PstlAdr.AdrLine[2]",
        ],
    ),
    *_gen_paths(
        ".Document.NtfctnToRcv.Ntfctn.Itm",
        [
            "Id",
            "EndToEndId",
            "UETR",
...
UNIVERSAL_POS = {p: i for i, p in enumerate(UNIVERSAL_CAMT057_ORDER)}
ALLOWED_ELEMENTS = frozenset(UNIVERSAL_CAMT057_ORDER)  # frozenset es más rápido
...
fields_spec: FieldsSpec = {
    ...
    ".Header.Message.MessageIdentifier": {
        ...
        "rules": [
            {
                "then": {"value": {"literal": "camt.057.001.06"}},
                "set": [
                    {
                        "set_var": {
    ...
    ".AppHdr.MsgDefIdr": {
        "mode": "set",
        "rules": [{"then": {"value": {"literal": "camt.057.001.06"}}}],
    },
    ".AppHdr.BizSvc": {
        "mode": "set",
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.EndToEndId": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.UETR": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Acct.Id.IBAN": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Acct.Id.Othr.Id": {
        "mode": "set",
        "rules": [
            {
                "when": {"all": [{"op": "=", "left": {"mt": "25"}, "right": ""}]},
    ...
    ".Document.NtfctnToRcv.Ntfctn.Acct.Id.Othr.SchmeNm.Cd": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Amt": {
        "mode": "set",
        "rules": [
            {
                "when": {"all": [{"op": "!=", "left": {"mt": "32B"}, "right": ""}]},
                "then": {
                    "value": {
                        "fn": "amount_normalize",
                        "args": {
                            "value": {"substr": {"value": {"mt": "32B"}, "start": 3}}
                        },
                    }
                },
            }
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Amt.@Ccy": {
        "mode": "set",
        "rules": [
            {
                "when": {"all": [{"op": "!=", "left": {"mt": "32B"}, "right": ""}]},
                "then": {
                    "value": {"substr": {"value": {"mt": "32B"}, "start": 0, "len": 3}}
                },
            }
        ],
    },
    ".Document.NtfctnToRcv.Ntfctn.XpctdValDt": {
        "mode": "set",
        "rules": [
            {
                "when": {"all": [{"op": "!=", "left": {"mt": "30"}, "right": ""}]},
                "then": {
                    "value": {
                        "fn": "yymmdd_to_yyyy_mm_dd",
                        "args": {
                            "value": {
                                "substr": {"value": {"mt": "30"}, "start": 0, "len": 6}
                            }
                        },
                    }
                },
    ...
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.BICFI": {
        "mode": "set",
        "rules": [
            {
                "when": {
                    "all": [
                        {"op": "!=", "left": {"mt": "52A"}, "right": ""},
                        {
                            ...
                            "left": {
                                ...
                                "args": {
                                    "text": {"mt": "52A"},
                                    "pattern": "^.{4}([A-Z]{4}[A-Z]{2}[A-Z0-9]{2}([A-Z0-9]{3})?)",
                                    "group": 1,
                                },
                            },
                            "right": "",
    ...
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.ClrSysMmbId.ClrSysId.Cd": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.ClrSysMmbId.MmbId": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.Nm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.PstlAdr.StrtNm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.PstlAdr.TwnNm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.PstlAdr.Ctry": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Purp.Prtry": {
        "mode": "set",
        "rules": [
            {
                "when": {
                ...
                "then": {"value": {"literal": "LIQUIDACION ANTICIP. CONVENIO ALADI"}},
            },
            {
                "when": {
                    "all": [
                ...
                "then": {"value": {"literal": "PAGO COMPENSACION CONVENIO ALADI"}},
            },
        ],
    },
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.BICFI": {
        "mode": "set",
        "rules": [
            {
                "when": {
                ...
                "set": [
                    ...
                    {
                        "set_var": {
                            "name": "has_Document.NtfctnToRcv.Ntfctn.Dbtr.Agt",
                            "value": {"literal": "1"},
                            "scope": "global",
                        }
                    },
    ...
    # --------- Party Identifier -> /ClrSysMmbId/ClrSysId/Cd (Cd) ----------
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.ClrSysMmbId.ClrSysId.Cd": {
        "mode": "set",
        "rules": [
            # --- 52A: FW (compatibilidad con regla previa) ---
            {
                "when": {
                    "all": [
                        {"op": "!=", "left": {"mt": "52A"}, "right": ""},
                        # BIC válido (8/11) en 52A
                        {
                            "op": "!=",
                            "left": {
                                "fn": "regex_extract",
            ...
            # --- 52A: //RT// + (SS)(code) => Cd = SS (sin tabla de equivalencias) ---
            {
                "when": {
                    "all": [
                        {"op": "!=", "left": {"mt": "52A"}, "right": ""},
            ...
            {
                # --- 52A: fallback SEGURO (SS + dígitos) => Cd = SS ---
                "when": {
                    "all": [
                        {"op": "!=", "left": {"mt": "52A"}, "right": ""},
                        # BIC válido (8/11) en 52A (mantengo tu condición)
                        {
                            "op": "!=",
                            "left": {
                                "fn": "regex_extract",
                        ...
                        # OJO: ahora solo matchea si luego de SS viene un dígito
                        {
                            "op": "!=",
                            "left": {
                                "fn": "regex_extract",
            ...
            # --- 52D (solo si NO hay 52A): mismos patrones ---
            {
                "when": {
                    "all": [
                        {"op": "=", "left": {"mt": "52A"}, "right": ""},
            ...
            {
                # --- 52D: fallback SEGURO (SS + dígitos) => Cd = SS ---
                "when": {
                    "all": [
                        {"op": "=", "left": {"mt": "52A"}, "right": ""},
                        {"op": "!=", "left": {"mt": "52D"}, "right": ""},
    ...
    # -------- Party Identifier -> /ClrSysMmbId/MmbId (MmbId) -------------
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.ClrSysMmbId.MmbId": {
        "mode": "set",
        "rules": [
            # --- 52A: FW ---
            {
            ...
            {
                # --- 52A: fallback SEGURO (SS + dígitos) => MmbId = dígitos+resto ---
                "when": {
                    "all": [
                        {"op": "!=", "left": {"mt": "52A"}, "right": ""},
                        # BIC válido (8/11) en 52A (mantengo tu condición)
                        ...
                        # OJO: ahora solo matchea si después de SS hay dígitos
                        {
                            "op": "!=",
                            "left": {
                                "fn": "regex_extract",
            ...
            {
                # --- 52D: fallback SEGURO (SS + dígitos) => MmbId = dígitos+resto ---
                "when": {
                    "all": [
                        {"op": "=", "left": {"mt": "52A"}, "right": ""},
                        {"op": "!=", "left": {"mt": "52D"}, "right": ""},
    ...
    # -------------- 52D -> Nm / PstlAdr (hasta 4 líneas, con o sin PartyId) --------------
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.Nm": {
        "mode": "set",
        "rules": [
            # Si hay PartyId (la primera línea empieza con / o //), entonces el nombre es la 2a línea.
            {
                "when": {
                    "all": [
                        {
            ...
            # Sin PartyId: el nombre es la 1a línea.
            {
                "when": {
                    "all": [
                        {
    ...
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.StrtNm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.TwnNm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.Ctry": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.AdrLine": {
        "mode": "append",
        "rules": [
            # ---------------------------
            # SIN PartyId: AdrLine = línea 2, 3, 4
            # ---------------------------
            # Línea 2
            {
                "when": {
                    "all": [
                        ...
                        {"op": "=", "left": {"var": "StrtNm"}, "right": ""},
                        {"op": "=", "left": {"var": "TwnNm"}, "right": ""},
                        {"op": "=", "left": {"var": "Ctry"}, "right": ""},
                        {"op": "=", "left": {"mt": "52A"}, "right": ""},
                        {"op": "!=", "left": {"mt": "52D"}, "right": ""},
                        {
                            "op": "=",
            ...
            # ---------------------------
            # CON PartyId: AdrLine = línea 3, 4, 5
            # (porque línea 1 = PartyId, línea 2 = Nm)
            # ---------------------------
            # Línea 3
            {
                "when": {
    ...
    # ---- Itm/IntrmyAgt ----
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.BICFI": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.ClrSysMmbId.MmbId": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.Nm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.PstlAdr.AdrLine[0]": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.PstlAdr.AdrLine[1]": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.PstlAdr.AdrLine[2]": {
        "mode": "set",
        "rules": [
            {
                "when": {
...
TEXTLIST_BY_PATH = {
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.PstlAdr.StrtNm": "short",
    ".Document.NtfctnToRcv.Ntfctn.Dbtr.Agt.FinInstnId.Nm": "short",
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.BICFI": "short",
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.ClrSysMmbId.ClrSysId.Cd": "short",
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.ClrSysMmbId.MmbId": "short",
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.Nm": "short",
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.AdrLine": "short",
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.StrtNm": "short",
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.TwnNm": "short",
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.Ctry": "short",
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.BICFI": "short",
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.ClrSysMmbId.ClrSysId.Cd": "short",
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.ClrSysMmbId.MmbId": "short",
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.Nm": "short",
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.PstlAdr.AdrLine[0]": "short",
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.PstlAdr.AdrLine[1]": "short",
    ".Document.NtfctnToRcv.Ntfctn.IntrmyAgt.FinInstnId.PstlAdr.AdrLine[2]": "short",
}
...
if __name__ == "__main__":
    ...
    if not files:
        dbg("No MT210 files found in", ubicationEntry)
