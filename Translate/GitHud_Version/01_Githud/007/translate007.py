...
fields_spec: FieldsSpec = {
    ...
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.StrtNm": {
        ...
        "rules": [
            ...
            "when": {"all": [
                ...
                {"op": "=", "left": {"mt": "52A"}, "right": ""},
                {"op": "!=", "left": {"mt": "52D"}, "right": ""},
                {"op": "=", "left": {"fn": "regex_extract", "args": {
                    "text": {"mt": "52D"}, "pattern": r"^(/|//)", "group": 1, "flags": 8
                }}, "right": ""},
                {"op": "!=", "left": {"fn": "regex_extract", "args": {
                    "text": {"mt": "52D"},
                    "pattern": r"^(?:[^\r\n]*\r?\n){1}([^\r\n]+)",
            ...
            "then": {"value": {"substr": {"value": {"trim": {"value": {"fn": "regex_extract", "args": {
                "text": {"mt": "52D"},
                "pattern": r"^(?:[^\r\n]*\r?\n){1}([^\r\n]*)",
                "group": 1, "flags": 8
            }}}}, "start": 0, "len": 70}}},
            "set": [
                {"set_var": {"name": "StrtNm", "value": {"literal": "1"}, "scope": "global"}},
                {"set_var": {"name": "has_Document.NtfctnToRcv.Ntfctn.Dbtr.Agt", "value": {"literal": "1"}, "scope": "global"}},
            ],
        },
        {
            "when": {"all": [
    ...
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.TwnNm": {
        ...
        "rules": [
            ...
            "set": [
                {"set_var": {"name": "TwnNm", "value": {"literal": "1"}, "scope": "global"}},
                {"set_var": {"name": "has_Document.NtfctnToRcv.Ntfctn.Dbtr.Agt", "value": {"literal": "1"}, "scope": "global"}},
            ],
        },
        {
    ...
    ".Document.NtfctnToRcv.Ntfctn.DbtrAgt.FinInstnId.PstlAdr.Ctry": {
        ...
        "rules": [
            ...
            "set": [
                {"set_var": {"name": "Ctry", "value": {"literal": "1"}, "scope": "global"}},
                {"set_var": {"name": "has_Document.NtfctnToRcv.Ntfctn.Dbtr.Agt", "value": {"literal": "1"}, "scope": "global"}},
            ],
        },
        {
