...
# -----------------------------------------------------------------------
traslateId = "007"
ubicationEntry = r"C:\Users\heoctor\Desktop\WANT\BANREP\Translete-Update\Translate Sin Comentarios\007\entry"
ubicationDestiny = r"C:\Users\heoctor\Desktop\WANT\BANREP\Translete-Update\Translate Sin Comentarios\007\destiny"
...
def get_list_from_values_db(df: pd.DataFrame, key: str) -> List[str]:
    ...
    return [c for c in col if c is not None and c != ""]
        ...
        "rules": [
            {
                ...
                "then": {"value": {"substr": {"value": {"mt": "20"}, "len": 35}}},
            }
        ],
    },
    ".AppHdr.MsgDefIdr": {
        ...
        "rules": [
            {
                "when": {"all": [{"op": "!=", "left": {"mt": "32B"}, "right": ""}]},
                "then": {
                    "value": {"substr": {"value": {"mt": "32B"}, "start": 0, "len": 10}}
                },
            }
        ],
    },
        ...
        "rules": [
            {
                ...
                "then": {"value": {"literal": "LIQUIDACIÓN ANTICIP. CONVENIO ALADI"}},
            },
            {
                "when": {
                    "all": [
