...
def _eval_value(
    ...
    if "substr" in vs:
        ...
        ignore_substr_trunc_fields = {"13D", "32A"}
        if (
            field_tag
            and in_output
...
def write_truncation_log(ts: str) -> None:
    ...
    lines.append("Message Type : MT900")
    lines.append("Exception Report:")
    lines.append("")
    lines.append("Envelope")
    lines.append("CAMT.05a to MT900 Translation Warnings:")
    lines.append(
    ...
    log_name = f"MT900_{ts}_TRUNC.txt"
...
if __name__ == "__main__":
    ...
    # Limpiar eventos de truncamiento por si se reutiliza el proceso
