...
fields_spec_72 = {
    "72": {
        ...
        "rules": [
            ...
            # ============================
            {
                # Prioridad: si viene InstrForNxtAgt.InstrInf, usarlo tal cual
                # Primera línea: 35 caracteres (incluye /REC/...)
                "when": {
                    "op": "!=",
                    "left": {
                        "xml_nth": {
            ...
            {
                # Segunda línea de /REC/: // + 33 caracteres desde posición 35
                "when": {
                    "all": [
                        {
                            "op": "!=",
            ...
            {
                # Tercera línea de /REC/: // + 33 caracteres desde posición 68
                "when": {
                    "all": [
                        {
                            "op": "!=",
...
if __name__ == "__main__":
    ...
    out_path.open("w", encoding="utf-8").write(mt)
