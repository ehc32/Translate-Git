...
fields_spec: FieldsSpec = {
    ...
    ".AppHdr.BizSvc": {
        ...
        "rules": [
            {
                "then": {
                    "value": { "literal": "swift.cbprplus.03"}
                }
            }
        ],
    },
   ...
   ".Document.NtfctnToRcv.Ntfctn.Acct.Id.IBAN": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.XpctdValDt": {
        "mode": "set",
        "rules": [
            {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Dbtr.Agt.FinInstnId.BICFI": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Dbtr.Agt.FinInstnId.ClrSysMmbId.ClrSysId.Cd": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Dbtr.Agt.FinInstnId.ClrSysMmbId.MmbId": {
    "mode": "set",
    "rules": [
        {
        "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Dbtr.Agt.FinInstnId.Nm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Dbtr.Agt.FinInstnId.PstlAdr.StrtNm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Dbtr.Agt.FinInstnId.PstlAdr.TwnNm": {
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Dbtr.Agt.FinInstnId.PstlAdr.Ctry": {
        "mode": "set",
        "rules": [
            {
                "when": {
        ...
        "rules": [
            {
                ...
                "then": {
                    "value": { "literal": "LIQUIDACIÓN ANTICIP. CONVENIO ALADI"}
                }
            }
        ],
    }
