...
".Document.NtfctnToRcv.Ntfctn.Itm.Acct.Id.IBAN": {
    "mode": "set",
    "rules": [
        {
            "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Acct.Id.Othr.Id":{
        "mode": "set",
        "rules": [
            {
                "when": {
    ...
    ".Document.NtfctnToRcv.Ntfctn.Itm.Acct.Id.Othr.SchmeNm.Cd":{
        "mode": "set",
        "rules": [
            {
                "when": {
        ...
        "rules": [
            {
                ...
                "then": {
                    "value": { "literal": "PAGO COMPENSACION CONVENIO ALADI"}
                }
            }
        ],
    }
