...
# -----------------------------------------------------------------------
traslateId = "005"
ubicationEntry = r"C:\Users\heoctor\Desktop\WANT\BANREP\Translete-Update\Translate Sin Comentarios\005\entry"
ubicationDestiny = r"C:\Users\heoctor\Desktop\WANT\BANREP\Translete-Update\Translate Sin Comentarios\005\destiny"
...
def _format_truncation_exception_report(ctx: FieldContext) -> str:
    ...
    lines.append("-" * 8)
    lines.append("")
    lines.append("MT292 to PACS.002 Translation Warnings:")
    lines.append(
